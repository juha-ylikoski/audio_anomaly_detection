...
This work tries to replicate paper from Dailan et al\cite{ELIC} which has introduced an efficient learned image compression method (ELIC) which fairs well in the benchmarks and is also reasonable in terms of computational cost.
...
This model optimizes the arithmetic encoders performance with input parameters from ... (some technical stuff about scctx) TEEMU?
