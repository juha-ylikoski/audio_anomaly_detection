...
% Single address.
% ---------------
\name{Authors\\ Juha Ylikoski, Nardos Estifanos, Teemu Eerola \\Tampere University\thanks{Thanks to XYZ agency for funding.}}
\address{\{juha.ylikoski, nardos.estifanos, teemu.eerola\}@tuni.fi}
%
% For example:
% ------------
%\address{School\\
